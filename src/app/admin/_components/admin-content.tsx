...
import type { ApplicationView } from "@/features/volunteer/server/applications.repo";
import {
  approveApplication,
  rejectApplication,
                ...
                return (
                  ...
                  >
                    ...
                    {record.status === "Verified" && (
                      <form action={routeCaseAction} className="mt-4 flex flex-wrap items-end gap-2.5">
